...
public class FlPlane : FlObjectBase
{
	...
	public FlPlaneParameter PlaneParameter => null;

	public MeshRenderer MeshRenderer => null;

	public MeshFilter MeshFilter => null;

	public Mesh[] MeshList => null;

	public Vector2[] UVColorInfoList => null;

	public Vector2[] UVAlphaInfoList => null;

	public Color[] VertexColorList => null;

	public float FillValue => default(float);

	public FlFillType FillType => default(FlFillType);
	...
	public void SetOuterSprite(Material material, [Optional] Sprite sprite, bool useFlashShader = true, [Optional] Texture colorTexture, [Optional] Texture alphaTexture, bool isSetSize = true, bool isSetUV = true)
	{
	}
	...
	public void ConvertToQuadGraphic([Optional] Texture edgeMaskTex, bool isPreConverted = false)
	{
	}
