...
public class ArrangeBulletData : ActionParts.PartsData
{
	...
	[SerializeField]
	[HideInInspector]
	private EffectObject.EraseType _abWaitingEffectEraseType;

	[SerializeField]
	[HideInInspector]
	private float _abWaitingEffectDisappearTime;
	...
	[SerializeField]
	[HideInInspector]
	private List<string> _abHitAttrLabelSubList;
	...
	public EffectObject.EraseType abWaitingEffectEraseType => default(EffectObject.EraseType);

	public float abWaitingEffectDisappearTime => default(float);

	public string abHitAttrLabel => null;

	public List<string> abHitAttrLabelSubList => null;
