...
public class PivotBulletData : BulletWithMarkerData
{
	...
	[SerializeField]
	[HideInInspector]
	private bool _useOwnerRotation;

	[SerializeField]
	[HideInInspector]
	private Vector3 _forceInitRotation;
	...
	public Vector3 defaultOffset => default(Vector3);

	public bool useOwnerRotation => default(bool);

	public Vector3 forceInitRotation => default(Vector3);
}
