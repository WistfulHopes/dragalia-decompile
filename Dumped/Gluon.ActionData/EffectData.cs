...
public class EffectData : ActionParts.PartsData
{
	...
	[SerializeField]
	[HideInInspector]
	private bool _isPlayingSkillCutInCameraOnly;
	...
	[SerializeField]
	[HideInInspector]
	private bool _removeFromCharacterEffectWhenStop;

	[SerializeField]
	[HideInInspector]
	private bool _fix377803Bug;
	...
	public bool isPlayingSkillCutInCameraOnly => default(bool);
	...
	public bool removeFromCharacterEffectWhenStop => default(bool);

	public bool fix377803Bug => default(bool);
