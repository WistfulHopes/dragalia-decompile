...
public class CommandData : ActionParts.PartsData
{
	public enum CharacterCommand
	{
		...
		CPCommand,
		NevOptionRemoteSync,
		DisplayEnemyAbilityIconForZako,
		CancelTransform,
		DeleteSettingHitOfSelf,
		NotStopCharaCtrlEffOnDeadState,
		RESERVE_37,
		RESERVE_38,
		RESERVE_39,
		AreaChange,
	...
	[SerializeField]
	[HideInInspector]
	private int _doNotExecuteWhenTransitionNextActionId;
	...
	public int doNotExecuteWhenTransitionNextActionId => default(int);
