...
public class CuttCharacterInitializer : MonoBehaviour
{
	...
	[SerializeField]
	private List<string> disablePartyCharaIdList;
	...
	public CuttTimelineCharacter[] InitIngameCuttForEight(CuttTimelineCharacter[] tempArray)
	{
		return null;
	}

	public CuttTimelineCharacter[] InitIngameCuttForDisableDeadChara(CuttTimelineCharacter[] tempArray)
	{
		return null;
	}

	public CuttTimelineCharacter[] InitIngameCuttForDisablePartyCharaList(CuttTimelineCharacter[] tempArray)
	{
		return null;
	}
