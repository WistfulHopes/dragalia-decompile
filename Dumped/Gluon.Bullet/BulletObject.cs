...
public class BulletObject : BulletBase
{
	...
	protected bool CreateHitAttributeForPlayer(ref CollisionHitAttribute hitAttribute, int actionId, int skillId, string label)
	{
		return default(bool);
	}

	protected bool CreateHitAttributeForEnemy(ref CollisionHitAttribute hitAttribute, int actionId, string label)
	{
		return default(bool);
	}
