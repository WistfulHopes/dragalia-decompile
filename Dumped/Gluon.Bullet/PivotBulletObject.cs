...
public class PivotBulletObject : BulletObjectWithMarker
{
	...
	public bool Initialize(CharacterBase owner, CommonObjectStatus target_, string hitAttrLabel, Vector3 anchor_position, float pivotRadius, float anchorForward, Vector3 anchorTransformPos, Quaternion anchorTransformRot, Vector3 forceInitRotation, [Optional] Action<HitException> hitCallBack)
	{
		return default(bool);
	}
