...
public class ActionPartsPivotBullet : ActionParts
{
	...
	private Vector3 CalcAnchorPosition(BaseAxisType type, CommonObjectStatus target, Vector3 defaultOffset, bool useOwnerRotation, out Vector3 position, out Quaternion rotation)
	{
