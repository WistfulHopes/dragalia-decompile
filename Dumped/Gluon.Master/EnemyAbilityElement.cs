...
public class EnemyAbilityElement : IMasterElement
{
	...
	[SerializeField]
	private float _DmgZoneR0801;

	[SerializeField]
	private float _DmgZoneR0802;

	[SerializeField]
	private float _Duration06;

	[SerializeField]
	private string _HitAttr1101;

	[SerializeField]
	private string _HitAttr1102;

	[SerializeField]
	private string _HitAttr1103;

	[SerializeField]
	private string _HitAttr1104;

	[SerializeField]
	private string _HitAttr1105;

	[SerializeField]
	private string _HitAttr1106;

	[SerializeField]
	private string _HitAttr1107;

	[SerializeField]
	private string _HitAttr1108;

	[SerializeField]
	private string _HitAttr1109;

	[SerializeField]
	private int _NoShuffle;
	...
	[SerializeField]
	private int _BuffId09;

	[SerializeField]
	private float _Duration07;

	[SerializeField]
	private int _ActionId05;

	[SerializeField]
	private float _Duration08;

	[SerializeField]
	private int _ActionId06;

	[SerializeField]
	private int _StopEnemyAbilityId;

	[SerializeField]
	private int _BorderHpRate;

	[SerializeField]
	private int _RecDmgRate05;

	[SerializeField]
	private int _BarrierType;

	[SerializeField]
	private int _RecDmgRate06;

	[SerializeField]
	private string _EffAttachNode;

	[SerializeField]
	private float _EffOffsetX;
	...
	public int OnlyOne => default(int);
	...
	public float DmgZoneR0801 => default(float);

	public float DmgZoneR0802 => default(float);

	public float Duration06 => default(float);

	public string HitAttr1101 => null;

	public string HitAttr1102 => null;

	public string HitAttr1103 => null;

	public string HitAttr1104 => null;

	public string HitAttr1105 => null;

	public string HitAttr1106 => null;

	public string HitAttr1107 => null;

	public string HitAttr1108 => null;

	public string HitAttr1109 => null;

	public int NoShuffle => default(int);

	public int LinkId => default(int);

	public int LinkNum => default(int);

	public int BuffId09 => default(int);

	public float Duration07 => default(float);

	public int ActionId05 => default(int);

	public float Duration08 => default(float);

	public int ActionId06 => default(int);

	public int StopEnemyAbilityId => default(int);

	public int BorderHpRate => default(int);

	public int RecDmgRate05 => default(int);

	public int BarrierType => default(int);

	public int RecDmgRate06 => default(int);

	public string EffAttachNode => null;

	public float EffOffsetX => default(float);

	public int HpRate => default(int);

	public int AreaType => default(int);
}
