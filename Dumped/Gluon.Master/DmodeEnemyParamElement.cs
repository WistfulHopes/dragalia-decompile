...
[Serializable]
public class DmodeEnemyParamElement : IMasterElement
{
	[SerializeField]
	private int _Id;
	...
	[SerializeField]
	private int _DropDmodePoint1;

	[SerializeField]
	private int _DropDmodePoint2;

	[SerializeField]
	private int _DmodeScore;
	...
	public int DropExp => default(int);

	public int DropDmodePoint1 => default(int);

	public int DropDmodePoint2 => default(int);
