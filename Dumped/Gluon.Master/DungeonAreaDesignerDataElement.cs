...
[Serializable]
public class DungeonAreaDesignerDataElement : IMasterElement
{
	[SerializeField]
	...
	[SerializeField]
	private float _CameraCollisionCenterPosX;

	[SerializeField]
	private float _CameraCollisionCenterPosZ;
	...
	public float CameraCollisionRadius => default(float);

	public float CameraCollisionCenterPosX => default(float);

	public float CameraCollisionCenterPosZ => default(float);
