...
[Serializable]
public class BuildEventItemElement : IMasterElement
{
	[SerializeField]
	private int _Id;
	...
	[SerializeField]
	private BuildEventItemType _EventItemType;
	...
	public BuildEventItemType EventItemType => default(BuildEventItemType);
