...
[Serializable]
public class MissionDailyDataElement : IMasterElement
{
	[SerializeField]
	private int _Id;
	...
	[SerializeField]
	private string _LockReceiveRewardEndDate;

	[SerializeField]
	private MissionLockRewardType _LockReceiveRewardType;

	[SerializeField]
	private int _LockReceiveRewardParam;
	...
	public string LockReceiveRewardEndDate => null;

	public MissionLockRewardType LockReceiveRewardType => default(MissionLockRewardType);

	public int LockReceiveRewardParam => default(int);
