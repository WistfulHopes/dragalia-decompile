...
[Serializable]
public class EarnEventItemElement : IMasterElement
{
	[SerializeField]
	private int _Id;
	...
	[SerializeField]
	private EarnEventItemType _EventItemType;
	...
	public EarnEventItemType EventItemType => default(EarnEventItemType);
