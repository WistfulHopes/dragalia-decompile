...
[Serializable]
public class MaterialShopMonthlyElement : IMasterElement
{
	[SerializeField]
	private int _Id;
	...
	public int GoodsViewType => default(int);
	...
	public int DayOfWeek => default(int);
	...
	public int IsAstralRaid => default(int);
}
