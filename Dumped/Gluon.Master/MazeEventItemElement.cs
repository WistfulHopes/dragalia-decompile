...
[Serializable]
public class MazeEventItemElement : IMasterElement
{
	[SerializeField]
	private int _Id;
	...
	[SerializeField]
	private MazeEventItemType _EventItemType;
	...
	public MazeEventItemType EventItemType => default(MazeEventItemType);
