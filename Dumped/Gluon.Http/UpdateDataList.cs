...
public class UpdateDataList
{
	...
	public DiamondData diamond_data;
	...
	public CollectEventUserList[] collect_event_user_list;

	public Clb01EventUserList[] clb_01_event_user_list;

	public ExRushEventUserList[] ex_rush_event_user_list;

	public SimpleEventUserList[] simple_event_user_list;

	public ExHunterEventUserList[] ex_hunter_event_user_list;

	public CombatEventUserList[] combat_event_user_list;
