...
public class AtomExCategoryController : VolumeControllerBase
{
	...
	public override void RelateSoundGroup(SoundGroup soundGroup, string[] atomCategoryNameArray)
	{
	}

	public override float GetVolume(string atomCategoryName)
	{
