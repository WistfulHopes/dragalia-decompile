...
public class EnemyCharacter : CharacterBase
{
	...
	public EnemyCtrl FindNextSubCharacter(int id, bool disableSort = false)
	{
		return null;
	}
	...
	protected override ApplyAbnormalStatusResult SetAbnormalStatus(CollisionHitAttribute attr, int conditionId, int damage, DamageReaction reaction, bool isIgnoreApplyAbnormalStatus)
	{
	...
	public override void RestoreStatusEffect([Optional] Func<EffectObject, bool> needsCheckEffectTriggerFunc)
	{
	}
