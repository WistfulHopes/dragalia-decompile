...
public class CharacterMarkUI : MonoBehaviour
{
	...
	public virtual EnemyAbilityHeadIconUI CreateEnemyAbilityHeadIconUI()
	{
		return null;
	}

	public virtual void ShowEnemyAbilityHeadIconUI(string iconName)
	{
	}

	public virtual void HideEnemyAbilityHeadIconUI()
	{
	}
