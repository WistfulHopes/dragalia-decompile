...
public class InGameUICtrl : FastUpdateMonoBehaviour
{
	...
	private InGameSystemMsgUI footerSystemMsgUI;
	...
	private Dictionary<CharacterBase, int> charaRemainLifeNumDict;
	...
	public void CloseRetryVoteDialog()
	{
	}
	...
	public void SetIngameCuttDof(bool enableFlag)
	{
	}
	...
	public void CreateCircleGaugeMeteorStrikeUI(CharacterBase owner)
	{
	}
	...
	public EnemyAbilityHeadIconUI CreateEnemyAbilityHeadIconUI(CharacterBase owner)
	{
		return null;
	}

	public void ShowEnemyAbilityHeadIconUI(CharacterBase owner, string iconName)
	{
	}

	public void HideEnemyAbilityHeadIconUI(CharacterBase owner)
	{
	}
	...
	public bool IsDisplayBuffCaption(CharacterBase chara, string text = "", float rate = 0f, bool isIncludeStack = false, BuffCaption.Param.DisplayIconType iconType = BuffCaption.Param.DisplayIconType.None, int iconElement = 0, AbilityConst.UnitType abilityOwnerUnit = AbilityConst.UnitType.None, int abilityOwnerId = 0)
	{
		return default(bool);
	}
	...
	public void OpenFooterSystemMessage(string text, bool se)
	{
	}

	public void CloseFooterSystemMessage()
	{
	}
	...
	public void NotifyUpdateBuffUI(CharacterBase chara)
	{
	}

	private void UpdateCharaRemainLifeNum(CharacterBase chara)
	{
	}

	public int GetCharaRemainLifeNum(CharacterBase chara)
	{
		return default(int);
	}
	...
	public static void SetAnimExposure(TweenUtil.ColorModulusArgs args, float toEvBy255)
	{
	}
	...
	public static void OnUpdateAnimFade(SpriteRenderer sprite, float from, float to, float t)
	{
	}

	public static void OnUpdateAnimFade(Text text, float from, float to, float t)
	{
	}

	public static void OnUpdateAnimColor(SpriteRenderer sprite, Color from, Color to, float t)
	{
	}

	public static void OnUpdateAnimExposure(TweenUtil.ColorModulusArgs args, float fromEvBy255, float toEvBy255, float t)
	{
	}

	public static void OnUpdateAnimPos(Transform trans, Vector3 from, Vector3 to, float t)
	{
	}

	public static void OnUpdateAnimPosX(Transform trans, float from, float to, float t)
	{
	}

	public static void OnUpdateAnimPosY(Transform trans, float from, float to, float t)
	{
	}

	public static void OnUpdateAnimScale(Transform trans, float from, float to, float t)
	{
	}

	public static void OnUpdateAnimScale(Transform trans, Vector3 from, Vector3 to, float t)
	{
	}

	public static void OnUpdateAnimRotZ(Transform trans, float from, float to, float t)
	{
	}
}
