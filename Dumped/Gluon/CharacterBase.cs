...
public class CharacterBase : RenderObjectBase
{
	...
	public CommonConstant.CharaUniqueIndex charaUniqueIndex
	{
		[CompilerGenerated]
		get
		{
			return default(CommonConstant.CharaUniqueIndex);
		}
		[CompilerGenerated]
		protected set
		{
	...
	public CommonConstant.DragonUniqueIndex dragonUniqueIndex
	{
		[CompilerGenerated]
		get
		{
			return default(CommonConstant.DragonUniqueIndex);
		}
		[CompilerGenerated]
		protected set
		{
	...
	public bool hideTransformEffectFlag
	{
		[CompilerGenerated]
		get
		{
	...
	public CharacterColor.State GetCurrentColorState => default(CharacterColor.State);
	...
	public ActionStartParameter GetSkillActionStartParameter()
	{
		return null;
	}
	...
	public void SetVisibleDecoWeapon(bool visible, bool forcibly = false)
	{
	}
	...
	protected int ActivateAbilityOnDamaged(int damage, bool isAnnihilationAttack, bool isSlipDamage, bool isSelfDamage, [Optional] CharacterDamageIntermediate intermediate)
	{
		return default(int);
	}
	...
	protected DamageReaction SetupDamageAction(CollisionHitAttribute attr, Vector3 collisionPos, int damage, bool isIgnoreApplyAbnormalStatus = false)
	{
		return default(DamageReaction);
	}
	...
	public virtual ApplyAbnormalStatusResult CheckAbnormalStatus(CollisionHitAttribute attr, int damage, DamageReaction reaction, bool isIgnoreApplyAbnormalStatus = false)
	{
		return default(ApplyAbnormalStatusResult);
	}

	private ApplyAbnormalStatusResult ActivateGrantedAbnormalStatus(CollisionHitAttribute attr, int damage, DamageReaction reaction, bool isIgnoreApplyAbnormalStatus)
	{
		return default(ApplyAbnormalStatusResult);
	}

	private ApplyAbnormalStatusResult ApplyGrantedAbnormalStatus(CollisionHitAttribute attr, List<CharacterBuff.GrantData> list, int damage, DamageReaction reaction, bool isIgnoreApplyAbnormalStatus)
	{
		return default(ApplyAbnormalStatusResult);
	}

	private ApplyAbnormalStatusResult ApplyAbnormalStatus(CollisionHitAttribute attr, int conditionId, int damage, DamageReaction reaction, bool isIgnoreApplyAbnormalStatus)
	{
		return default(ApplyAbnormalStatusResult);
	}

	protected virtual ApplyAbnormalStatusResult SetAbnormalStatus(CollisionHitAttribute attr, int conditionId, int damage, DamageReaction reaction, bool isIgnoreApplyAbnormalStatus)
	{
		return default(ApplyAbnormalStatusResult);
	}
	...
	public float StartReborn(float baseRebornHpRatio, bool withSpCharge = false, float spChargeRate = 0f)
	{
		return default(float);
	}
	...
	public virtual void RestoreStatusEffect([Optional] Func<EffectObject, bool> needsCheckEffectTriggerFunc)
	{
	}
	...
	public bool IsSpAvailable(int idx, bool ignoreConsumeCp = false)
	{
		return default(bool);
	}

	public bool IsCpAvailable(int idx)
	{
		return default(bool);
	}
	...
	public void ForceStopActionEffect(bool isAnimatableObjectOnly = false, bool is377803BugCase = false)
	{
	}
	...
	public void SetModelVisibilityForSkillCutInCamera(bool visibility, [Optional] Func<EffectObject, bool> needsCheckEffectTriggerFunc)
	{
	}
