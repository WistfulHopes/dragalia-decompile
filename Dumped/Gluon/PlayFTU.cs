...
public class PlayFTU : FastUpdateMonoBehaviour
{
	...
	public class SkillCutInSpriteInfo
	{
		...
		private float differenceImageShowTime;
	...
	private static readonly Type[] storyIgnoreFlashList;
	...
	private void SetupFlashInfo(GameObject prefab, Action<PlayFTU> endFunc, ref FlashInfo fi)
	{
	}
	...
	public void Pause(Type type, bool isPause)
	{
	}

	private void Pause(ref FlashInfo fi, bool isPause)
	{
	}

	public void PauseCharaSpecific(bool isPause)
	{
	}
	...
	private void Stop(ref FlashInfo fi)
	{
	}
	...
	private void StopImmediate(ref FlashInfo fi)
	{
	}

	private void StopImmediateCharaSpecific(CharaSpecificFlashInfo csfi)
	{
	}
	...
	private bool CheckStoryIgnore(Type type)
	{
		return default(bool);
	}
