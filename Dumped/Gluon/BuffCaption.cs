...
public class BuffCaption : FastUpdateMonoBehaviour
{
	public class Param
	{
		...
		public bool IsMatchForAura(string text, float rate, int iconElement)
		{
			return default(bool);
		}
	}
	...
	public bool IsMatch(CharacterBase chara, string text, float rate, bool isIncludeStack, Param.DisplayIconType iconType, int iconElement, AbilityConst.UnitType abilityOwnerUnit, int abilityOwnerId)
	{
		return default(bool);
	}
