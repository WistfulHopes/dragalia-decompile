...
public class CharacterBuff
{
	...
	public class Regeneration
	{
		...
		public void SetIsBuffState(CharacterBuffType buffType, int conditionId)
		{
		}
	...
	public List<(int, bool)> removedBuffUnionList;
	...
	private static List<CharacterBuffAutoLevelInfo> autoLevelInfoList;

	private List<List<UnifiedParameter>> unifiedDicValuesForLoop;
	...
	public static void SetupAutoLevelInfo()
	{
	}
	...
	public bool ProcessScaledBuffOnRemoveForReason(CharacterBuffType type, Parameter buffDebuff, RemoveBuffReason reason, [Optional] Action OnChangeDuration)
	{
		return default(bool);
	}
	...
	public bool GetLevel(CharacterBuffType buffType, bool isBuff, out int level, out int maxLevel)
	{
		return default(bool);
	}

	public bool GetLevel(int buffIconId, bool isBuff, out int level, out int maxLevel)
	{
		return default(bool);
	}

	private bool GetLevel(int conditionId, out int level, out int maxLevel)
	{
		return default(bool);
	}
	...
	private void CheckValid(AuraID auraId, CharacterBuffType buffType, float rate, Parameter.InternalFlagType internalFlag, ActionConditionElement ace)
	{
	}
	...
	public bool HasAnyDamageShield()
	{
		return default(bool);
	}
	...
	public bool HasUniqueBuff_C6_01()
	{
		return default(bool);
	}
	...
	public void ExecUniqueBuff_C6_01(CharacterBase owner, bool fromSync = false)
	{
	}
	...
	public bool CanDispel(CharacterBase owner, CharacterBase from, int conditionId, int actionId, int skillId, int productId, int buffExplosionHitId = 0)
	{
		return default(bool);
	}

	private void CheckDispelProductionForReceiver(CharacterBase owner, CharacterBase from, int conditionId, int actionId, int skillId, int productId, int buffExplosionHitId = 0)
	{
	}
