...
public class InGameBuffUI : SingletonMonoBehaviour<InGameBuffUI>
{
	...
	public class BuffData
	{
		...
		public void Set(CharacterBase chara, CharacterBuffType buffType, bool isBuff, int conditionId, int productId, int count, int percent, int level, int maxLevel, int durationNum, float durationTime, float lifeTime, int quantity, int durationTimeScale)
		{
		}

		public void Update(CharacterBase chara, int count, int percent, int level, int maxLevel, int durationNum, float durationTime, float lifeTime, int quantity, int durationTimeScale)
		{
		}
	...
	private List<int> _workCollectMixBuffIndexList;
	...
	private bool SetBuffList(CharacterBase chara, List<BuffData> buffList, List<BuffData> standbyBuffList, CharacterBuffType buffType, bool isBuff, int buffIconId, int conditionId, int productId, int count, int percent, int level, int maxLevel, int durationNum, float durationTime, float lifeTime, int quantity, int durationTimeScale)
	{
		return default(bool);
	}
