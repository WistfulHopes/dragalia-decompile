...
public class EnemyAbilityProcBase
{
	...
	public EnemyAbilityElement data
	{
		[CompilerGenerated]
		get
		{
	...
	public virtual void ShowForZako()
	{
	}
	...
	public virtual void HideForZako()
	{
	}
	...
	public void KickEffectTrigger(int trig, [Optional] Func<EffectObject, bool> needsCheckEffectTriggerFunc)
	{
	}

	public void RemoveEffectControl()
	{
	}
	...
	public virtual void OnCharacterInit()
	{
	}
	...
	public virtual void OnCalcAdditionalDamage(ref EnemyAbility.Argument arg)
	{
	}

	public virtual void OnCalcFinalDamageAttack(ref EnemyAbility.Argument arg)
	{
	}

	public virtual void OnCalcFinalDamageReceive(ref EnemyAbility.Argument arg)
	{
	}

	public virtual void OnCalcFinalAbnormalSlipDamage(ref EnemyAbility.Argument arg)
	{
	}

	public virtual void OnCalcFinalBuffExtraDamage(ref EnemyAbility.Argument arg)
	{
	}

	public virtual void OnCalcFinalAdditionalDamage(ref EnemyAbility.Argument arg)
	{
	}
	...
	public virtual void OnApplySlipDamage(ref EnemyAbility.Argument arg, ref int damage, AbnormalStatusType abnormalStatusType, CharacterBuffType buffType)
	{
	}

	public virtual void OnApplyBuffExtraDamage(ref EnemyAbility.Argument arg)
	{
	}
	...
	public virtual void OnAbnormalStatusProbabilityAttack(ref EnemyAbility.Argument arg)
	{
	}
	...
	public virtual void OnPlayQTECutt()
	{
	}
	...
	public void CreateCharacterMarkCommonUI()
	{
	}
