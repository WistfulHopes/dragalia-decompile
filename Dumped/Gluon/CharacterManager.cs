...
public class CharacterManager : IGetCharacter
{
	...
	public CharacterBase GetCurrentCharacterAndSupport(CharacterBase target, bool bugfix = false)
	{
		return null;
	}
	...
	public List<CharacterBase> GetAliveCharacters(bool includeSupporter = true)
	{
		return null;
	}
	...
	public void SetCharacterShader(List<PlayerEventReceiver> playerEventReceiverList, bool isDefault, bool isRestart)
	{
	}
