...
public class EnemyAbilityProcPowerCrystal : EnemyAbilityProcBase
{
	...
	private Vector3 _zoneEffScaleBase;
	...
	private EffectObject PlayEffect2(string effName, Vector3 scale, int effTrigger = 8, [Optional] Action<EffectObject> onReturnPool)
	{
		return null;
	}
	...
	private void OnReturnPool(EffectObject eo)
	{
	}
