...
public class MainGameCtrl : MonoBehaviour
{
	...
	private bool disableAutoPlayForIngameCutt;
	...
	private int frameRateSettingUpdateInGame;
	...
	public bool ingameCuttIsQuestEndCutt
	{
		[CompilerGenerated]
		get
		{
	...
	public bool isQuestEndCuttFinished
	{
		[CompilerGenerated]
		get
		{
	...
	public bool ReservedRetry => default(bool);
	...
	public bool NeedsFadeForInGameCuttStart()
	{
		return default(bool);
	}
	...
	public void PlayIngameCutt(int id = 0, bool isQuestEndCutt = false)
	{
	}

	private IEnumerator PlayIngameCuttCoroutine(int id)
	{
		return null;
	}
	...
	public bool IsXenosQuest()
	{
		return default(bool);
	}

	public bool IsXenosRevivalQuest()
	{
		return default(bool);
	}

	private bool IsAutoAreaChangeWithFinishCamera()
	{
		return default(bool);
	}
	...
	private bool UpdateCheckReservedRetry()
	{
		return default(bool);
	}
	...
	public DungeonEffectObject[] GetDungeonEffectObjects(bool includeInactive)
	{
		return null;
	}
	...
	private bool CanAutoSkipAlreadyReadStory()
	{
		return default(bool);
	}
}
