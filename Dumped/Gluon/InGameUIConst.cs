...
public static class InGameUIConst
{
	...
	public static readonly string NameCharaCircleGaugeMeteorStrike;

	public static readonly string NameEnemyAbilityHeadGaugeUI;

	public static readonly string NameEnemyAbilityHeadIconUI;
	...
	public static readonly string NameInGameRemainlifeIconUI;
	...
	public static readonly string NameInGameCuttCommandCircleGauge;
