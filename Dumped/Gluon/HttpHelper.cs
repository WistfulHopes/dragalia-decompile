...
public class HttpHelper
{
	...
	private const int autoRetryCountMax = 1;
	...
	public static void SendSilently<T1, T2>(T1 req, Action<T2> onSuccess, [Optional] Action<ErrorType, int> onError, bool auth = false) where T2 : class
	{
	}
